...
for (const lang of LANGUAGES) {
  LANG_MAP[lang.name] = lang.code;
  LANG_CODE_TO_NAME[lang.code] = lang.name;
}
LANG_MAP["Chinese Simplified"] = "zh-CN";
LANG_MAP["Chinese Traditional"] = "zh-TW";

export function mapLang(name: string): string {
  return LANG_MAP[name] ?? name.toLowerCase();
}
